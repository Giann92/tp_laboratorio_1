    ...
    if(this != NULL && nodeIndex >=0 && nodeIndex <=len ){
    	if(pNewNode != NULL){
    		...
    		if(nodeIndex == 0){
    			...
    			pAntes = getNode(this, nodeIndex);
    			pNewNode->pNextNode = pAntes->pNextNode;
    			pAntes->pNextNode = pNewNode;
    		}
    		else if(nodeIndex == len){
    			nodeIndex = nodeIndex-1;
    			pAntes = getNode(this, nodeIndex);
    ...
    if(index >= 0 && index < len){
    	...
    	if(pNodeRemove != NULL){
    		if(index == 0){
    			...
    			index = index -1;
    			pAntesNode = getNode(this, index);
    			pAntesNode->pNextNode = pNodeRemove->pNextNode;
    			free(pNodeRemove);
    			pNodeRemove = NULL;
    		}
    		len--;
...
int ll_push(LinkedList* this, int index, void* pElement)
{
    ...
    if(this != NULL){
    	...
    	if(index >= 0 && index <= len){
    		...
    		returAddNode = addNode(this, index, pElement);
    		if(returAddNode == 0){
    		returnAux = 0;
    		}
    		len++;
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this != NULL && this2 != NULL){
    	...
    	for(i = 0 ; i < lenLis2 ; i ++){
    		...
    		list2 = ll_contains(this, pNodeAux);
    ...
    if(this != NULL &&pFunc != NULL && (order == 1 || order == 0)){
    	...
    	for(i = 0 ; i < len ; i++){
    		...
    		for(j = i+1; j < len ; j++){
    			...
    			if(order ==1){
    				orden = pFunc(pElement1 , pElement2);
    				if(orden == 1){
